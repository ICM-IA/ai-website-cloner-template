...
const instalaciones: Instalacion[] = [
  { lat: -35.2150446, lng: -58.2451647, ciudad: "Eduardo Guyet – Las Malvinas", direccion: "Carport solar con inversor híbrido trifásico y baterías de litio", tipo: "Residencial", potencia: "10 kW" },
  { lat: -35.287135, lng: -58.191897, ciudad: "Liliana – Jeppener", direccion: "Sistema fotovoltaico híbrido para sector laboral y vivienda + bombeo solar para riego", tipo: "Comercial", potencia: "20 kW + 8 kW + 550 W" },
  { lat: -35.5182551, lng: -58.310992, ciudad: "Diego – Ranchos", direccion: "Termotanque solar inoxidable", tipo: "Termotanque", potencia: "200 L" },
  { lat: -35.4968614, lng: -58.3826282, ciudad: "Hugo Ghilini", direccion: "Sistema fotovoltaico híbrido monofásico con baterías de litio", tipo: "Residencial", potencia: "6 kW" },
  { lat: -34.0631123, lng: -60.074885, ciudad: "Jorge Zabaleta", direccion: "Hotel Acapulco — 3 termotanques solares inoxidables", tipo: "Termotanque", potencia: "600 L" },
  { lat: -35.277236, lng: -58.199908, ciudad: "Supermercado El Mono", direccion: "Sistema fotovoltaico híbrido trifásico con 2 inversores y banco de baterías", tipo: "Comercial", potencia: "30 kW" },
  { lat: -35.1166978, lng: -58.2790097, ciudad: "Rubén – Las Acacias", direccion: "Sistema fotovoltaico off-grid con batería Growatt", tipo: "Residencial", potencia: "5 kW" },
  { lat: -35.2758585, lng: -58.2041943, ciudad: "Pedro Pacheco", direccion: "Sistema fotovoltaico híbrido monofásico con baterías de litio", tipo: "Residencial", potencia: "6 kW" },
  { lat: -35.05443, lng: -58.3696166, ciudad: "Nicolás Monaco", direccion: "Bomba solar sumergida a 12 m para agua de ganado", tipo: "Agropecuario", potencia: "600 W" },
  { lat: -35.40542, lng: -58.374685, ciudad: "Pablo – Ranchos", direccion: "Termotanque solar inoxidable con controlador TK-8", tipo: "Termotanque", potencia: "300 L" },
  { lat: -35.277698, lng: -58.189733, ciudad: "Isabel Saavedra", direccion: "Termotanque solar inoxidable con controlador TK-8", tipo: "Termotanque", potencia: "200 L" },
  { lat: -35.5101613, lng: -58.3154904, ciudad: "María Oporto", direccion: "Termotanque solar galvanizado con controlador TK-8", tipo: "Termotanque", potencia: "200 L" },
  { lat: -35.6325417, lng: -58.2847254, ciudad: "Agustín Santalucía", direccion: "Bomba solar sumergida a 12 m para agua de ganado", tipo: "Agropecuario", potencia: "300 W" },
  { lat: -35.0713102, lng: -58.1678952, ciudad: "Matías Longoni", direccion: "Termotanque solar galvanizado con controlador TK-8", tipo: "Termotanque", potencia: "150 L" },
  { lat: -34.964616, lng: -58.248025, ciudad: "Hernán Mannarino – Pozo 1", direccion: "Bomba solar sumergida a 18 m para agua de ganado. Mismo cliente: 2° pozo (Pozo 2) cercano.", tipo: "Agropecuario", potencia: "600 W" },
  { lat: -34.997399, lng: -58.303434, ciudad: "Hernán Mannarino – Pozo 2", direccion: "Bomba solar sumergida a 18 m para agua de ganado. Mismo cliente: 1° pozo (Pozo 1) cercano.", tipo: "Agropecuario", potencia: "600 W" },
  { lat: -35.385838, lng: -58.650491, ciudad: "Julián Udaondo", direccion: "3 bombas solares de 300 W + 1 de 600 W para agua de ganado", tipo: "Agropecuario", potencia: "4 bombas" },
  { lat: -35.457084, lng: -58.355241, ciudad: "Pablo Suárez – Estancia La Ñata", direccion: "Conversión a bomba solar 1,5 HP con variador de frecuencia, para agua de ganado", tipo: "Agropecuario", potencia: "1,5 HP" },
  { lat: -35.274953, lng: -58.200538, ciudad: "Mayorista Andell", direccion: "Sistema fotovoltaico híbrido trifásico de gran escala con banco de 12 baterías de litio", tipo: "Comercial", potencia: "50 kW" },
  { lat: -35.277017, lng: -58.203064, ciudad: "Mirta – Jeppener", direccion: "Sistema fotovoltaico off-grid con batería de litio", tipo: "Residencial", potencia: "6 kW" },
  { lat: -35.244891, lng: -58.222614, ciudad: "Estancia La Victoria", direccion: "Sistema fotovoltaico híbrido trifásico con baterías de litio. Mismo cliente que Estancia La Victoria – Bombeo.", tipo: "Agropecuario", potencia: "20 kW" },
  { lat: -35.243764, lng: -58.221948, ciudad: "Estancia La Victoria – Bombeo", direccion: "2 bombas solares (pozo principal y auxiliar) para agua de ganado. Mismo cliente: también cuenta con sistema fotovoltaico.", tipo: "Agropecuario", potencia: "2 bombas" },
  { lat: -35.174455, lng: -58.228884, ciudad: "Emiliano Cortés – ESB", direccion: "Sistema fotovoltaico híbrido monofásico con baterías de litio", tipo: "Residencial", potencia: "6 kW" },
  { lat: -32.625696, lng: -59.971763, ciudad: "Yety S.A. – Entre Ríos", direccion: "Bomba solar híbrida sumergida a 66 m, con respaldo de grupo electrógeno nocturno", tipo: "Agropecuario", potencia: "2200 W" },
  { lat: -35.203853, lng: -58.394904, ciudad: "Haras de Oroite", direccion: "Bomba solar sumergida a 12 m para agua de ganado", tipo: "Agropecuario", potencia: "750 W" },
  { lat: -35.040642, lng: -58.443735, ciudad: "Miguel Gambarte", direccion: "Sistema fotovoltaico híbrido trifásico con baterías de litio", tipo: "Residencial", potencia: "10 kW" },
  { lat: -34.8766962, lng: -58.3894315, ciudad: "Heladería Grido – Glew", direccion: "Sistema fotovoltaico on-grid para ahorro en factura", tipo: "Comercial", potencia: "10 kW" },
  { lat: -34.87805, lng: -58.38765, ciudad: "Alfredo Ferreti – Glew", direccion: "Sistema fotovoltaico híbrido monofásico con baterías de litio", tipo: "Residencial", potencia: "6 kW" },
  { lat: -35.0246477, lng: -58.4192803, ciudad: "Graciela Huerdo", direccion: "Sistema fotovoltaico off-grid, bajo consumo", tipo: "Residencial", potencia: "5 kW" },
