...
export const articles: Article[] = [
  {
    ...
    coverEmoji: '🌊',
    coverBg: '#0a2318',
    coverImage: 'https://images.unsplash.com/photo-1619546952812-520e98064a52?w=800&q=80&auto=format&fit=crop',
    body: [
  ...
  },
  {
    ...
    coverEmoji: '🏙️',
    coverBg: '#0a1225',
    coverImage: '/images/miami-brickell.jpg',
    body: [
  ...
  },
  {
    ...
    coverEmoji: '🌆',
    coverBg: '#1a0d02',
    coverImage: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=800&q=80&auto=format&fit=crop',
    body: [
  ...
  },
  {
    ...
    coverEmoji: '🏛️',
    coverBg: '#0a0a1f',
    coverImage: 'https://images.unsplash.com/photo-1589909202802-8f4aadce1849?w=800&q=80&auto=format&fit=crop',
    body: [
